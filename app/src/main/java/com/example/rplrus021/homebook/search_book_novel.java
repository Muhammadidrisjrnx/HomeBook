...
public class search_book_novel extends AppCompatActivity {
    GridView gvbuku2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_book_novel);
    ...
    public class search_data_novel extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected void onPostExecute(JSONObject jsonObject) {
            ...
            try {
                ...
                CostumAdapter2 customAdapter = new CostumAdapter2(homebook, search_book_novel.this);
